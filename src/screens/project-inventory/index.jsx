...
import { apartment_white, apartment_grey, floor_plan, floor_plan_two, gallery, galler_two, info, info_two, inventory, inventory_two, walkthrough, walkthrough_two } from '../../assets/icons';
                        ...
                        <div className="project-home-header inventory-header">
                            ...
                            <div className="project-info project-info-inventory">
                                    <div className="project-info-inner-row project-info-inner-row-first">
                                        ...
                                        <div className="col-3"><img src={apartment_white} /></div>
